...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Accesssite'), array('action' => 'edit', $accesssite['Accesssite']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Accesssite'), array('action' => 'delete', $accesssite['Accesssite']['id']), array(), __('Are you sure you want to delete # %s?', $accesssite['Accesssite']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Accesssites'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Accesssite'), array('action' => 'add')); ?> </li>
