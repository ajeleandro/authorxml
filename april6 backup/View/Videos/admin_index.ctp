<div class="videos index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('videoid'); ?></th>
			<th><?php echo $this->Paginator->sort('title'); ?></th>
			<th><?php echo $this->Paginator->sort('duration'); ?></th>
			<th><?php echo $this->Paginator->sort('height'); ?></th>
			<th><?php echo $this->Paginator->sort('width'); ?></th>
			<th><?php echo $this->Paginator->sort('player'); ?></th>
			<th><?php echo $this->Paginator->sort('playerkey'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($video['Video']['player']); ?>&nbsp;</td>
		<td><?php echo h($video['Video']['playerkey']); ?>&nbsp;</td>
		<td>
