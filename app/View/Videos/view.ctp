...
<h2><?php echo __('Video'); ?></h2>
    ...
    <dl>
		...
		<dt><?php echo __('Video asset file name'); ?></dt>
		<dd>
		    ...
		    <dd>
                ...
                foreach($video['Contributor'] as $contributors){ 
                    ...
                    if($contributors['type'] == 0){
                         ...
                         echo nl2br($contributors['Degrees']."\n");
    ...
    &nbsp;
    <h3 style="margin-top: 3%;">Timing</h3>
	<dl>
		<dt><?php echo __('Cue points'); ?></dt>
		<dd>
	...
	<dl>
        ...
        <dt><?php echo __('Book Mapping'); ?></dt>
		<dd>
			<?php echo h($video['Video']['Book Mapping']); ?>
			&nbsp;
		</dd>
        <dt><?php echo __('Parent Category'); ?></dt>
		<dd>
			<?php echo $this->Html->link($parentcategory['name'], array('controller' => 'categories', 'action' => 'view', $parentcategory['id'])); ?>
			&nbsp;
		</dd>
